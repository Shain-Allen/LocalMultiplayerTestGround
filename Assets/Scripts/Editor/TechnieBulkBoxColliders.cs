 ...
 *
 */
public class TechnieBulkBoxColliders
{
	[MenuItem("Window/Technie Collider Creator/Run Bulk Box Colliders (Bulk Collider Generate)", false, 2000)]
